...
pub struct ReplayRunArgs<'a, NestedTraceDecoderT, BlockT, TxT, HardforkT, ChainContextT> {
...
/// Arguments to `replay_run`.
pub struct ReplayErrorArgs<'a, NestedTraceDecoderT, BlockT, TxT, HardforkT, ChainContextT> {
    pub executor: Executor<BlockT, TxT, HardforkT, ChainContextT>,
...
fn set_up_inner_replay<BlockT, TxT, HardforkT, ChainContextT>(
